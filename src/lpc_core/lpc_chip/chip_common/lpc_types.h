...
#define Function(address)   (*((PFV)address))()    ////////////////////自己添加的
/**
 * @}
 */
...
#define SETBIT(val, offset)    	(val |= 1 << offset)
#define CLRBIT(val, offset)  	(val &= ~(1 << offset))
#define GETBIT(val, offset)	   	((val >> offset) & 0x01)				////自己添加的
